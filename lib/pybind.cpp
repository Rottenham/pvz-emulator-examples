...
PYBIND11_MODULE(pvzemu, m) {
    ...
    py::enum_<zombie_reanim_name>(m, "ZombieReanimName")
        .value("_ground", zombie_reanim_name::_ground)
        .value("anim_smash", zombie_reanim_name::anim_smash)
        .value("anim_dolphinjump", zombie_reanim_name::anim_dolphinjump)
        .value("anim_ride", zombie_reanim_name::anim_ride)
        .value("anim_jumpinpool", zombie_reanim_name::anim_jumpinpool)
        .value("anim_idle", zombie_reanim_name::anim_idle)
        .value("anim_grab", zombie_reanim_name::anim_grab)
        .value("anim_ladderwalk", zombie_reanim_name::anim_ladderwalk)
        .value("anim_laddereat", zombie_reanim_name::anim_laddereat)
        .value("anim_walk_nopaper", zombie_reanim_name::anim_walk_nopaper)
        .value("anim_swim", zombie_reanim_name::anim_swim)
        .value("anim_uptoeat", zombie_reanim_name::anim_uptoeat)
        .value("anim_drill", zombie_reanim_name::anim_drill)
        .value("anim_dizzy", zombie_reanim_name::anim_dizzy)
        .value("anim_walk2", zombie_reanim_name::anim_walk2)
        .value("anim_walk", zombie_reanim_name::anim_walk)
        .value("anim_dance", zombie_reanim_name::anim_dance)
        .value("anim_drop", zombie_reanim_name::anim_drop)
        .value("anim_run", zombie_reanim_name::anim_run)
        .value("anim_walkdolphin", zombie_reanim_name::anim_walkdolphin)
        .value("anim_dig", zombie_reanim_name::anim_dig)
        .value("anim_drive", zombie_reanim_name::anim_drive)
        .value("anim_pogo", zombie_reanim_name::anim_pogo)
        .value("anim_moonwalk", zombie_reanim_name::anim_moonwalk)
        .value("anim_raise", zombie_reanim_name::anim_raise)
        .value("anim_pop", zombie_reanim_name::anim_pop)
        .value("anim_gasp", zombie_reanim_name::anim_gasp)
        .value("anim_eat", zombie_reanim_name::anim_eat)
        .value("anim_eat_nopaper", zombie_reanim_name::anim_eat_nopaper)
        .value("anim_point", zombie_reanim_name::anim_point)
        .value("anim_armraise", zombie_reanim_name::anim_armraise)
        .value("anim_wheelie1", zombie_reanim_name::anim_wheelie1)
        .value("anim_wheelie2", zombie_reanim_name::anim_wheelie2)
        .value("anim_bounce", zombie_reanim_name::anim_bounce)
        .value("anim_death", zombie_reanim_name::anim_death)
        .value("anim_death2", zombie_reanim_name::anim_death2)
        .value("anim_superlongdeath", zombie_reanim_name::anim_superlongdeath)
        .value("anim_waterdeath", zombie_reanim_name::anim_waterdeath)
        .value("anim_throw", zombie_reanim_name::anim_throw)
        .value("anim_jump", zombie_reanim_name::anim_jump)
        .value("anim_shoot", zombie_reanim_name::anim_shoot)
        .value("anim_land", zombie_reanim_name::anim_land)
        .value("anim_landing", zombie_reanim_name::anim_landing)
        .value("anim_thrown", zombie_reanim_name::anim_thrown)
        .value("anim_placeladder", zombie_reanim_name::anim_placeladder);
    ...
    py::enum_<plant_reanim_name>(m, "PlantReanimName")
        .value("anim_charge", plant_reanim_name::anim_charge)
        .value("anim_unarmed_idle", plant_reanim_name::anim_unarmed_idle)
        .value("anim_block", plant_reanim_name::anim_block)
        .value("anim_crumble", plant_reanim_name::anim_crumble)
        .value("anim_loop", plant_reanim_name::anim_loop)
        .value("anim_attack", plant_reanim_name::anim_attack)
        .value("anim_shoot", plant_reanim_name::anim_shoot)
        .value("anim_idle", plant_reanim_name::anim_idle)
        .value("anim_bigidle", plant_reanim_name::anim_bigidle)
        .value("anim_scared", plant_reanim_name::anim_scared)
        .value("anim_scaredidle", plant_reanim_name::anim_scaredidle)
        .value("anim_sleep", plant_reanim_name::anim_sleep)
        .value("anim_explode", plant_reanim_name::anim_explode)
        .value("anim_grow", plant_reanim_name::anim_grow)
        .value("anim_glow", plant_reanim_name::anim_glow)
        .value("anim_armed", plant_reanim_name::anim_armed)
        .value("anim_land", plant_reanim_name::anim_land)
        .value("anim_bite", plant_reanim_name::anim_bite)
        .value("anim_chew", plant_reanim_name::anim_chew)
        .value("anim_swallow", plant_reanim_name::anim_swallow)
        .value("anim_idlehigh", plant_reanim_name::anim_idlehigh)
        .value("anim_lower", plant_reanim_name::anim_lower)
        .value("anim_rise", plant_reanim_name::anim_rise)
        .value("anim_lookleft", plant_reanim_name::anim_lookleft)
        .value("anim_lookright", plant_reanim_name::anim_lookright)
        .value("anim_jumpup", plant_reanim_name::anim_jumpup)
        .value("anim_jumpdown", plant_reanim_name::anim_jumpdown)
        .value("anim_splitpea_shooting", plant_reanim_name::anim_splitpea_shooting)
        .value("anim_nonactive_idle2", plant_reanim_name::anim_nonactive_idle2)
        .value("anim_shooting", plant_reanim_name::anim_shooting)
        .value("anim_shootinghigh", plant_reanim_name::anim_shootinghigh);
    ...
    py::enum_<zombie_damage_flags>(m, "ZombieDamageFlags")
        .value("ignore_accessory_2", zombie_damage_flags::ignore_accessory_2)
        .value("not_reduce", zombie_damage_flags::not_reduce)
        .value("slow_effect", zombie_damage_flags::slow_effect)
        .value("no_flash", zombie_damage_flags::no_flash)
        .value("disable_ballon_pop", zombie_damage_flags::disable_ballon_pop)
        .value("spike", zombie_damage_flags::spike);
    
    py::enum_<zombie_attack_type>(m, "ZombieAttackType")
        .value("smash_or_eat", zombie_attack_type::smash_or_eat)
        .value("crush", zombie_attack_type::crush)
        .value("jump", zombie_attack_type::jump)
        .value("place_ladder", zombie_attack_type::place_ladder);
